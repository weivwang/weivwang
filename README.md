...
[![](https://img.shields.io/badge/traceweave-PyPI-369eff?style=flat-square&logo=pypi&logoColor=white)](https://pypi.org/project/traceweave/)
![](https://komarev.com/ghpvc/?username=weivwang&style=flat-square&color=369eff)
...
**🔍 [traceweave](https://github.com/weivwang/trace-wave)**

Distributed tracing & observability for AI agents. Trace every LLM call, tool use, and agent decision with 2 lines of code.

`pip install traceweave`

![Python](https://img.shields.io/badge/-Python-369eff?style=flat-square&logo=python&logoColor=white)
![PyPI](https://img.shields.io/pypi/v/traceweave?style=flat-square&color=369eff)
...
Exploring multi-agent orchestration, agent observability, and LLM application development. From Stanford CS231n to production AI systems.

![LLM](https://img.shields.io/badge/-LLM-bc8cff?style=flat-square)
![Agents](https://img.shields.io/badge/-AI_Agents-3fb950?style=flat-square)
...
2026 ─── 🔍 Launched traceweave — open-source AI agent observability
```
